...
{
    public class FattorahBusinessPlanFaliedModel : PageModel
    {
        ...
        string res { set; get; }
        public FattorahBusinessPlanFaliedModel(CRMDBContext context, IEmailSender emailSender, UserManager<ApplicationUser> userManager, IConfiguration configuration, ApplicationDbContext applicationDbContext)
        {
            _context = context;
                        ...
                        try
                        {
                            if (fattorahPaymentResult.UserDefinedField != null)
                            {
                                ...
                                if (checkRes)
                                {
                                    ...
                                    var BussinessObj = _context.BussinessPlans.Where(e => e.BussinessPlanId == businiessSubscription.BussinessPlanId).FirstOrDefault();
