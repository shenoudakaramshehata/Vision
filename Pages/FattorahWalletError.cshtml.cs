...
{
    public class FattorahWalletErrorModel : PageModel
    {
        ...
        string res { set; get; }
        public FattorahWalletErrorModel(CRMDBContext context, IEmailSender emailSender, UserManager<ApplicationUser> userManager, IConfiguration configuration, ApplicationDbContext applicationDbContext)
        {
            _context = context;
