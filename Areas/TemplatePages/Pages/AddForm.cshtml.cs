...
namespace Vision.Areas.TemplatePages.Pages
{
    public class AddFormModel : PageModel
    {
        ...
        public AddFormModel(IRazorPartialToStringRenderer renderer, IWebHostEnvironment hostEnvironment, CRMDBContext Context, UserManager<ApplicationUser> userManager)
        {
            _context = Context;
        ...
        public async void OnGet()
        {
            try
            {
                ...
                var ClassifiedCategory = _context.ClassifiedAdsCategories.Where(e => e.ClassifiedAdsCategoryId == 59).FirstOrDefault();
                ...
                {
                    lstColumns = _context.AdTemplateConfigs.Include(c => c.AdTemplateOptions).Include(c => c.FieldType).Where(c => c.ClassifiedAdsCategoryId == 59).OrderBy(c => c.SortOrder).ToList();
                }
                ...
                FormTemplate = System.IO.File.ReadAllText(_hostEnvironment.WebRootPath + "\\AdsTemplates\\59.txt");
        ...
        public async Task<ActionResult> OnPost(IFormFile formfile)
        {
            try
            {
                ...
                foreach (AdTemplateConfig field in fields)
                {
                    ...
                    switch (field.FieldTypeId)
                    {
                        ...
                        case 8:
                            ...
                            addSingleFile(formfile, ConfigId, ClassifiedAdId);
                            break;
                        case 9:
