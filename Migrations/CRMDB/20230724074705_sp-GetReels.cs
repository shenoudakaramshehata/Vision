...
{
    public partial class spGetReels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"CREATE PROCEDURE [dbo].[GetReels]
...
FROM            dbo.ClassifiedAd LEFT OUTER JOIN
						 ...
						 where dbo.ClassifiedAd.IsActive=1
                END";
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE dbo.GetReels ");
